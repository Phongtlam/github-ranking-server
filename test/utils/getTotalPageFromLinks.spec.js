...
test('return correct max page count', () => {
  const link = '<https://api.github.com/organizations/913567/repos?page=2&sort=updated>; rel="next", <https://api.github.com/organizations/913567/repos?page=6&sort=updated>; rel="last"';
