...
const { queryParamsBuilder, extractGetQueryParams } = require('../../utils/queryParams.js');
...
test('extracts get query params with non org to be netflix', () => {
  expect(extractGetQueryParams({
    url: 'www.new-app.com?orgName=neworg&hello=1&newVal=value&array=1%2C2%2C3'
  })).toEqual(  {
    query: {
      hello: '1',
      newVal: 'value',
